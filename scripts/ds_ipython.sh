...
CID_ipython=$(docker run -d -v $DS_DIR/dockerfiles/ipython_node/notebooks:/root/notebooks --privileged --dns 8.8.8.8 -p 8888:8888 --name ipython -h ipython -i -t hwxu/ipython_node bash)
